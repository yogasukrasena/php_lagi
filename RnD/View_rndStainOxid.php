...
//$field1=$_POST['field1'];
//$field2=$_POST['field2'];
$field1=StainOxidecode;
$field2=StainOxideDescription;
...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndStainOxide.php" name="SearchStainOxide">
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditStainOxide.php?id=$alldata[ID]\">$alldata[StainOxideCode]</a></td>
	...
	<a class=\"InLineDataLink\" href=\"ShowStainOxide.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditStainOxide.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  <tr>
	...
	<input type="hidden" name="tablename" value="tblStainOxide">
	<input type="hidden" name="field1" value="StainOxideCode">
	<input type="hidden" name="field2" value="StainOxideDescription">
	<input type="hidden" name="pagename" value="view_rndStainOxide.php">
  </tr>
  <!-- END Error -->
  <tr>
