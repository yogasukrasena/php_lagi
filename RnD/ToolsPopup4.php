...
<title>R&amp;D - TOOLS</title>
<link rel="stylesheet" type="text/css" href="../includes/Style.css">
<SCRIPT LANGUAGE="JavaScript">
<!--
function pick(symbol) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampCeramicForm.Tools4.value = symbol;
  window.close();
}
// -->
</SCRIPT>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
					...
					<a href=\"#\" onClick=\"javascript:pick('$alldata[ToolsCode]')\" class=\"InLineDataLink\" >$alldata[ToolsCode]	</a></td>
