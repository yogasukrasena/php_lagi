...
$query = $query . " ORDER BY ClayCode ASC LIMIT $from, $maxresult";
...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndClay.php" name="SearchClay">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Clay </font></td>
		  </tr>
          <tr>
	  ...
	  <br>
      <font class="InLineFormHeaderFont">List of Clay </font><br>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditClay.php?id=$alldata[ID]\">$alldata[ClayCode]</a></td>
    <td class=\"InLineDataTD\" colspan=\"5\">$alldata[ClayDescription]</td> 
    <td class=\"InLineDataTD\"><img class=\"InLineInput\" height=\"50\" src=\"../UploadImg/$alldata[ClayPhoto1]\" width=\"50\">&nbsp;</td>
    <td class=\"InLineDataTD\">
	<a class=\"InLineDataLink\" href=\"ShowClay.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditClay.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<form name="AddClay" action="AddData.php" method="post" >
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD CLAY</td> <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblClay">
	<input type="hidden" name="field1" value="ClayCode">
	<input type="hidden" name="field2" value="ClayDescription">
	<input type="hidden" name="pagename" value="view_rndClay.php">
  </tr>
  <!-- END Error -->
  <tr>
