...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndTexture.php" name="SearchTexture">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Texture </font></td>
		  </tr>
          <tr>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditTexture.php?id=$alldata[ID]\" >$alldata[TextureCode]</a></td>
	...
	<a class=\"InLineDataLink\" href=\"ShowTexture.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditTexture.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD TEXTURE </td> 
    <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblTexture">
	<input type="hidden" name="field1" value="TextureCode">
	<input type="hidden" name="field2" value="TextureDescription">
	<input type="hidden" name="pagename" value="view_rndTexture.php">
  </tr>
  <!-- END Error -->
  <tr>
