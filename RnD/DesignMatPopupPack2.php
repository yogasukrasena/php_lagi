...
function pick(symbol,supplier,unitvalue,unitprice) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampPackagingForm.DesMat2.value = symbol;
    <!--window.opener.document.SampPackagingForm.DesMat2Desc.value = desc;-->
    window.opener.document.SampPackagingForm.DesMatSup2.value = supplier;
    window.opener.document.SampPackagingForm.DesMatUnit2.value = unitvalue;
    window.opener.document.SampPackagingForm.DesMatUnitPrice2.value = unitprice;			
  window.close();
}
// -->
</SCRIPT>
