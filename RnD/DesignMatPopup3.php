...
function pick(symbol) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampCeramicForm.DesignMat3.value = symbol;
  window.close();
}
// -->
</SCRIPT>
		...
		<td>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
    				<td class=\"InLineDataTD\"><input type=\"hidden\" name=\"DmCode\" value=\"$alldata[DmCode]\" />
					<a href=\"#\" onClick=\"javascript:pick('$alldata[DmCode]')\" class=\"InLineDataLink\" >$alldata[DmCode]	</a></td>
