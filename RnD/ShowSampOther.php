...
<title>Sample Other - Work Plan</title>
      ...
      <td class="GraphiteDataTD" colspan="6" nowrap>
		  <table width="100%" cellpadding="3" cellspacing="0" border="1">
		  	<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><strong>Qty</strong></td>
				<td width="10%" align="center" class="GraphiteDataTD"><strong>Unit</strong></td>
				<td width="10%" align="right" class="GraphiteDataTD"><strong>Unit Price</strong></td>
				<td width="10%" align="right" class="GraphiteDataTD"><strong>Total</strong></td>
			</tr>
			<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><?php echo $alldata['QtyDesMat1']?></td>
				<td width="10%" align="center" class="GraphiteDataTD"><?php echo $alldata1['UnitValue']?></td>
			...
			<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><?php echo $alldata['QtyDesMat2']?></td>
				<td width="10%" align="center" class="GraphiteDataTD"><?php echo $alldata2['UnitValue']?></td>
			...
			<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><?php echo $alldata['QtyDesMat3']?></td>
				<td width="10%" align="center" class="GraphiteDataTD"><?php echo $alldata3['UnitValue']?></td>
			...
			<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><?php echo $alldata['QtyDesMat4']?></td>
				<td width="10%" align="center" class="GraphiteDataTD"><?php echo $alldata4['UnitValue']?></td>
			...
			<tr>
				...
				<td width="10%" align="right" class="GraphiteDataTD"><?php echo $alldata['QtyDesMat5']?></td>
				<td width="10%" align="center" class="GraphiteDataTD"><?php echo $alldata5['UnitValue']?></td>
      ...
      <td class="GraphiteDataTD" colspan="6" nowrap>
		  <table width="100%" cellpadding="3" cellspacing="0" border="1">
		  	<tr>
				...
				<td width="20%" align="right" class="GraphiteDataTD"><strong>Cost Price</strong></td>
			</tr>
			<tr>
				<td width="30%" class="GraphiteDataTD">
					<?php
