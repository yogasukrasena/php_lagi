...
function pick(symbol,supplier,unitvalue,unitprice) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampPackagingForm.DesMat1.value = symbol;
    <!--window.opener.document.SampPackagingForm.DesMat1Desc.value = desc;-->
    window.opener.document.SampPackagingForm.DesMatSup1.value = supplier;
    window.opener.document.SampPackagingForm.DesMatUnit1.value = unitvalue;
    window.opener.document.SampPackagingForm.DesMatUnitPrice1.value = unitprice;			
  window.close();
}
// -->
</SCRIPT>
