...
$field_supplier = $_POST['supp'];

	$query = "SELECT tblDesMaterial.*, tblSupplier.* FROM tblDesMaterial INNER JOIN tblSupplier ON tblDesMaterial.DmSupplier = tblSupplier.SupCode WHERE 1=1  ";

if (!empty($field1_value))
{
	$query .= " AND DmCode = '$field1_value'";
}
if (!empty($field2_value))
{
	$query .= " AND DmDescription LIKE '%$field2_value%'";
}
if (!empty($field_supplier))
{
	$query .= " AND tblSupplier.SupCompany LIKE '%$field_supplier%'";
}
    ...
    <td colspan="2"><form method="post" action="view_rndDesMaterial.php" name="SearchDesMaterial">
        <table width="772" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          ...
          <tr>
            ...
            <td width="85" class="InLineDataTD"><input class="InLineInput" value="" name="kode" maxlength="12" size="12"></td>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <tr>
    ...
    <td width="89" nowrap class="InLineColumnTD"><!-- BEGIN Sorter Sorter7 -->
      <a class="InLineSorterLink" href="#">SUPPLIER</a></td>
    <td width="89" nowrap class="InLineColumnTD"><!-- BEGIN Sorter Sorter7 -->
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){
    ...
    <td class=\"InLineDataTD\">$alldata[SupCompany]&nbsp;</td>
