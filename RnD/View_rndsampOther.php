  ...
  <tr>
    <td colspan="2"><form method="post" action="View_rndSampOther.php" name="SearchSampOther">
        <table width="791" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
		  <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Sample Other </font></td>
		  </tr>
          <tr>
      ...
      <br>
      <font class="InLineFormHeaderFont">List of Sample Other </font><br>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <tr>
    ...
    <td width="250" nowrap class="InLineColumnTD" colspan="5"><!-- BEGIN Sorter Sorter2 -->
        <a class="InLineSorterLink" href="#">DESCRIPTION</a>
      <!-- END Sorter Sorter2 -->
      &nbsp;</td>
    <td width="95" class="InLineColumnTD"><!-- BEGIN Sorter Sorter7 -->
    ...
    <td width="80" nowrap class="InLineColumnTD">COPY</td>
    <td width="80" nowrap="nowrap" class="InLineColumnTD">REF</td>
  </tr>
  <!-- BEGIN Row -->
  <?php
//  $jmldata=0;
		while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  			echo"<tr>
    			...
    			<td class=\"InLineDataTD\">
					<a onmouseover=\"status='Search Record...';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"ShowSampOther.php?id=$alldata[ID]&DesMat1=$alldata[DesMat1]&DesMat2=$alldata[DesMat2]&DesMat3=$alldata[DesMat3]&DesMat4=$alldata[DesMat4]&DesMat5=$alldata[DesMat5]&Supplier1=$alldata[Supplier1]&Supplier2=$alldata[Supplier2]&Supplier3=$alldata[Supplier3]&Supplier4=$alldata[Supplier4]&Supplier5=$alldata[Supplier5]\" target=\"_blank\">show</a>\t
					<a onmouseover=\"status='Search Record...';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"view_editsampOther.php?id=$alldata[ID]&DesMat1=$alldata[DesMat1]&DesMat2=$alldata[DesMat2]&DesMat3=$alldata[DesMat3]&DesMat4=$alldata[DesMat4]&DesMat5=$alldata[DesMat5]\" >edit</a>
				</td>
...
<p></p>
<form action="AddData.php" name="add_Sample_Other" method="post">
  <table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
    <!-- BEGIN Error -->
    <tr>
      <input type="hidden" name="tablename" value="SampleOther">
      <input type="hidden" name="field1" value="SampleCode">
      <input type="hidden" name="field2" value="Description">
      <input type="hidden" name="pagename" value="View_rndSampOther.php">
    </tr>
    <!-- END Error -->
    <tr>
