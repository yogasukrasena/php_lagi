...
function pick(symbol,supplier,unitvalue,unitprice) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampPackagingForm.DesMat5.value = symbol;
    window.opener.document.SampPackagingForm.DesMatSup5.value = supplier;
    window.opener.document.SampPackagingForm.DesMatUnit5.value = unitvalue;
    window.opener.document.SampPackagingForm.DesMatUnitPrice5.value = unitprice;			
  window.close();
}
// -->
</SCRIPT>
