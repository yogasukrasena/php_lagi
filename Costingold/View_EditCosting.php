		...
		?>		
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
      			<tr>
        			...
        			<td colspan="4" class="InLineDataTD"><b>Description</b><br /><?php echo $alldata['Description']?>&nbsp;</td>
      			</tr>
				<tr>
				...
				<?php
					...
					//{
						$DesignMatQuery = mysql_query("SELECT SampleCeramic.sID, tblDesMaterial.*, tblUnit.* FROM sampleceramic INNER JOIN tblDesMaterial ON SampleCeramic.DesignMat1 = tblDesMaterial.DmCode INNER JOIN tblUnit ON tblDesMaterial.DmUnit = tblUnit.UnitID WHERE sID = $sid");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DmDescription']?></td>
        			...
        			<td align="right" class="InLineDataTD"><?php echo money_form($DesignMatData['DmUnitPrice'])?></td>	
					<?php $DesignMatCost = ($alldata['DesignMatQty1'] * $DesignMatData['DmUnitPrice']); ?>
