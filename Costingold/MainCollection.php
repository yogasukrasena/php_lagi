...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td width="50%" height="39" class="TopContentTitle">COSTING</td>
  	</tr>
  	<tr>
    	<td>&nbsp;</td>
  	</tr>
    			...
    			<tr>
      				...
      				<td class="InLineDataTD">
        				<select name="DesignSelect" class="InLineSelect">
 						...
 						<?php
							echo $DesignCode;//nti hapus line ini
		...
		<td>
			...
			<table width="100%" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  				<tr>
					...
					<td nowrap="nowrap" class="InLineColumnTD"><a class="InLineSorterLink" href="#">PRICE+RISK</a></td>	
    				<td nowrap="nowrap" class="InLineColumnTD"><a class="InLineSorterLink" href="#">REAL SELLING PRICE</a></td>	
  				</tr>
  				<!-- BEGIN New Row -->
				...
				$SizeData = mysql_fetch_array($Size);
  				...
  				echo"<tr>
					<td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"#\">$alldata[CollectCode]</a></td>
					...
					If (Empty($alldata[RiskPrice])) {
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCollect.php?sid=$alldata[ID]\">Add</a>";
					}
					Else{
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCollect.php?id=$alldata[ID]\">".money_form($alldata[RiskPrice])."</a>";
					}
			echo"</td>"
					?>
					<td class="InLineDataTD">
					...
					If (Empty($alldata[RealSellingPrice])) {
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCollect.php?id=$alldata[ID]&DesMaterial1=$alldata[DesignMat1]\">Add</a>";
					}
					Else{
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCosting.php?sid=$alldata[ID]&DesMaterial1=$alldata[DesignMat1]\">".money_form($alldata[RealSellingPrice])."</a>";
					}
			echo"</td>
  				</tr>";
				}
