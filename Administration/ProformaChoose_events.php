...
$DeliveryAddressID = $Grid->DeliveryAddressID->GetValue();
$DeliveryContactID = $Grid->DeliveryContactID->GetValue();
$doc = CCGetFromGet("doc","");
if($doc == "i"){
  $Grid->Proforma_H_ID->SetLink("AddInvoice1.php?Proforma_H_ID=$Pro_H_ID&AddressID=$AddressID&InvoiceContactID=$ContactID&DeliveryAddressID=$DeliveryAddressID&DeliveryContactID=$DeliveryContactID&ClientID=$ClientID");
}elseif($doc == "p"){
