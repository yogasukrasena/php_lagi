...
//Page_BeforeInitialize @1-893144D8
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $RnDPriceList; //Compatibility
...
//Page_AfterInitialize @1-884FB00F
