<?php
//Include Common Files @1-FBD97F9C
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "InvChoice.php");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "InvChoice.html";
$BlockToParse = "main";
...
$Link3->Page = "AddInvoice1.php";
$Link1 = new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Page = "QuotChoose.php";
$MainPage->Link2 = & $Link2;
$MainPage->Link3 = & $Link3;
$MainPage->Link1 = & $Link1;
$Link2->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link2->Parameters = CCAddParam($Link2->Parameters, "doc", i);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Parameters = CCAddParam($Link1->Parameters, "doc", i);
