...
$QuotationContactID = $GridList->ContactID->GetValue();
$DeliveryAddressID = $GridList->DeliveryAddressID->GetValue();
$DeliveryContactID = $GridList->DeliveryContactID->GetValue();
$ClientID = $GridList->ClientID->GetValue();
$Quo_H_ID = $GridList->Quotation_H_ID->GetValue();
$doc = CCGetFromGet("doc","");
if($doc == "i"){
  $GridList->Quotation_H_ID->SetLink("AddInvoice1.php?Quotation_H_ID=$Quo_H_ID&AddressID=$AddressID&InvoiceContactID=$QuotationContactID&DeliveryAddressID=$DeliveryAddressID&DeliveryContactID=$DeliveryContactID&ClientID=$ClientID");
}elseif($doc == "p"){
  $GridList->Quotation_H_ID->SetLink("AddProforma.php?Quotation_H_ID=$Quo_H_ID&AddressID=$AddressID&ContactID=$QuotationContactID&DeliveryAddressID=$DeliveryAddressID&DeliveryContactID=$DeliveryContactID&ClientID=$ClientID");
}
//End Custom Code
