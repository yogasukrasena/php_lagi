...
<!--	<div id=\"navsite\">
	  ...
	  <ul>
		...
		<li><a href=\"CollectionGroup.php\">View Collection Group</a></li>
	  </ul>
	<div id=\"navsite\">	  
	  <h5><b>Document :</b></h5>
	  <ul>
        <li><a href=\"RnDPriceList.php\">R&D Price List</a></li>
        <li><a href=\"PriceList.php\">Collection Price List</a></li>			  
