...
//Include Common Files @1-863951CD
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "LPInvoice.php");
...
//Class_Initialize Event @2-62EAC280
    function clsRecordAddNew($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->TextArea1->Page = "InvPayment.php";
            $this->Link1 = new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", $Method, NULL), $this);
            $this->Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
            $this->Link1->Page = "Invoice.php";
        }
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "LPInvoice.html";
$BlockToParse = "main";
