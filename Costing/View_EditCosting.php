  	...
  	<tr>
		...
		?>		
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
      			<tr>
        			<td colspan="3" class="InLineDataTD"><b>Sample Code</b><br /><?php echo $alldata['SampleCode']?>&nbsp;</td>
        			<td colspan="4" class="InLineDataTD"><b>Description</b><br /><?php echo $alldata['SampleDescription']?>&nbsp;</td>
      			</tr>
				<tr>
        			<td width="16%" class="InLineDataTD"><b>Barcode</b><br />
       			  &nbsp;</td>
        			<td colspan="2" class="InLineDataTD"><b>Client Code</b><br /><?php echo $alldata['ClientCode']?>&nbsp;</td>
        			<td colspan="4" class="InLineDataTD"><b>Client Description</b><br />
				...
				<?php
					...
					//{
						$DesignMatQuery = mysql_query("SELECT SampleCeramic.sID, tblDesignMat.*, tblUnit.* FROM sampleceramic INNER JOIN tblDesignMat ON SampleCeramic.DesignMat1 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE sID = $sid");
				...
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT SampleCeramic.sID, tblDesignMat.*, tblUnit.* FROM sampleceramic INNER JOIN tblDesignMat ON SampleCeramic.DesignMat2 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE sID = $sid");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
				...
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT SampleCeramic.sID, tblDesignMat.*, tblUnit.* FROM sampleceramic INNER JOIN tblDesignMat ON SampleCeramic.DesignMat3 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE sID = $sid");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
				...
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT SampleCeramic.sID, tblDesignMat.*, tblUnit.* FROM sampleceramic INNER JOIN tblDesignMat ON SampleCeramic.DesignMat4 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE sID = $sid");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
