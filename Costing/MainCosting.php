...
<table border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="MainCosting.php" name="SearchSampOther">
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <tr>
    <td width="71" nowrap class="InLineColumnTD"><!-- BEGIN Sorter Sorter1 -->
      <a class="InLineSorterLink" href="MainCosting.php">CODE</a></td>
    <td width="350" nowrap class="InLineColumnTD"><!-- BEGIN Sorter Sorter2 -->
        <a class="InLineSorterLink" href="#">DESCRIPTION</a>
      <!-- END Sorter Sorter2 -->
      &nbsp;</td>
    <td width="100" nowrap="nowrap" class="InLineColumnTD"><a class="InLineSorterLink" href="#">PHOTO</a></td>
    <td width="100" nowrap="nowrap" class="InLineColumnTD"><a class="InLineSorterLink" href="#">PRICE +<BR />
      RISK</a></td>
    <td width="100" nowrap="nowrap" class="InLineColumnTD"><a class="InLineSorterLink" href="#">REAL<BR />SELLING<BR />PRICE</a></td>
  </tr>
  <!-- BEGIN Row -->
  <?php
//  $jmldata=0;
		while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  			echo"<tr>
				...
				<td width=\"85\" class=\"InLineDataTD\">$alldata[SampleDescription]</td>
    			<td class=\"InLineDataTD\"><img class=\"InLineInput\" height=\"50\" src=\"../Upload/$alldata[Photo1]\" width=\"50\"></td>"
  ?>
    			<td align="right" class="InLineDataTD">
					<?php 
					If (Empty($alldata[RiskPrice])) {
						echo "<a class=\"InLineDataLink\" href=\"View_EditCosting.php?sid=$alldata[sID]\">Add</a>";
					}
					Else{
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCosting.php?sid=$alldata[sID]\">".money_form($alldata[RiskPrice])."</a>";
					}
			echo"</td>"
					?>
    			<td align="right" class="InLineDataTD">
    				<?php 
					If (Empty($alldata[RealSellingPrice])) {
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCosting.php?sid=$alldata[sID]&DesMaterial1=$alldata[DesignMat1]\">Add</a>";
					}
					Else{
						echo "<a onmouseover=\"status='';return true\" onmouseout=\"status='';return true\" class=\"InLineDataLink\" href=\"View_EditCosting.php?sid=$alldata[sID]&DesMaterial1=$alldata[DesignMat1]\">".money_form($alldata[RealSellingPrice])."</a>";
					}
			echo"</td>
  			</tr>";
		}
