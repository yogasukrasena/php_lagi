...
if (!$_SESSION["userlogin"]) {
	...
	$TotalAllCost = $ClayCost + $ClayPreparationCost + $WheelCost + $SlabCost + $CastingCost + $FinishingCost + $GlazingCost + $StandardBisqueCost + $StandardGlazeCost + $RakuBisqueCost + $RakuGlazeCost + $DesignMatCost1 + $DesignMatCost2 + $DesignMatCost3 + $DesignMatCost4 + $MovementCost + $PackagingWorkCost;
