...
<table width="70%" border="0" cellspacing="0" cellpadding="0">
  	...
  	<tr>
		...
		<?php
			error_reporting(0);
			$CollectID=$_GET['ID'];
			$result = mysql_query("SELECT tblcollect_texture.TextureName, tblcollect_size.SizeName, tblcollect_name.NameDesc, tblcollect_category.CategoryName, tblcollect_color.ColorName, tblcollect_design.DesignName, tblcollect_material.MaterialName,tblcollect_master.ID, tblcollect_master.CollectCode,tblcollect_master.ClayKG,tblcollect_master.ClayType, tblcollect_master.ClayCost,tblcollect_master.ClayPreparationMinute,tblcollect_master.ClayPreparationCost,tblcollect_master.WheelMinute, tblcollect_master.WheelCost,tblcollect_master.SlabMinute,tblcollect_master.SlabCost,tblcollect_master.CastingMinute,  tblcollect_master.CastingCost, tblcollect_master.FinishingCost, tblcollect_master.FinishingMinute,tblcollect_master.GlazingMinute,  tblcollect_master.GlazingCost,tblcollect_master.StandardBisqueLoading,tblcollect_master.StandardBisqueCost,  tblcollect_master.StandardGlazeLoading,tblcollect_master.StandardGlazeCost,tblcollect_master.RakuBisqueLoading,  tblcollect_master.RakuBisqueCost,tblcollect_master.RakuGlazeLoading,tblcollect_master.RakuGlazeCost,tblcollect_master.MovementMinute,  tblcollect_master.MovementCost,tblcollect_master.PackagingWorkMinute,tblcollect_master.PackagingWorkCost,  tblcollect_master.ClayPreparationPPH,tblcollect_master.WheelPPH,tblcollect_master.SlabPPH,tblcollect_master.CastingPPH,  tblcollect_master.FinishingPPH,tblcollect_master.GlazingPPH,tblcollect_master.MovementPPH,tblcollect_master.PackagingWorkPPH,  tblcollect_master.TotalAllCost,tblcollect_master.RiskPrice,tblcollect_master.HypoSellingPrice,tblcollect_master.RealSellingPrice,  tblcollect_master.LastUpdate , tblcollect_master.ClientCode,tblcollect_master.ClientDescription 
FROM tblcollect_category INNER JOIN tblcollect_master ON (tblcollect_category.CategoryCode=tblcollect_master.CategoryCode) INNER JOIN tblcollect_color ON (tblcollect_color.ColorCode=tblcollect_master.ColorCode) INNER JOIN tblcollect_design ON (tblcollect_design.DesignCode=tblcollect_master.DesignCode) INNER JOIN tblcollect_material ON (tblcollect_material.MaterialCode=tblcollect_master.MaterialCode) INNER JOIN tblcollect_texture ON (tblcollect_texture.TextureCode=tblcollect_master.TextureCode) INNER JOIN tblcollect_size ON (tblcollect_size.SizeCode=tblcollect_master.SizeCode) INNER JOIN tblcollect_name ON (tblcollect_name.NameCode=tblcollect_master.NameCode) WHERE ID = $CollectID");
			$alldata = mysql_fetch_array($result);
		?>		
			<form name="EditCollect" method="post" action="EditCollect.php">
			<input type="hidden" name="ID" value="<?php echo $CollectID ?>" />
			<input type="hidden" name="DesignMat1" value="<?php echo $result['DesignMat1']?>"/>
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
				...
				<tr>
		  	  	  	<td width="16%" rowspan="5" align="center" class="InLineDataTD"><b>DESIGN MATERIAL</b>&nbsp;</td>
				...
				<tr>
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT tblCollect_Master.ID, tblDesignMat.*, tblUnit.* FROM tblCollect_Master INNER JOIN tblDesignMat ON tblCollect_Master.DesignMat1 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE ID = $CollectID");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
        			<td class="InLineDataTD" width="13%"><?php echo $alldata['DesignMatQty1']?></td>
        			<td align="center" class="InLineDataTD"><?php echo $DesignMatData['UnitValue']?>&nbsp;</td>
        			<td align="right" class="InLineDataTD"><?php echo money_form($DesignMatData['DesignMatUnitPrice'])?></td>	
					<?php $DesignMatCost1 = ($alldata['DesignMatQty1'] * $DesignMatData['DesignMatUnitPrice']); ?>
        			<td colspan="2" align="right" class="InLineDataTD"><?php echo money_form($DesignMatCost1)?> </td>
				</tr>
				<tr>
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT tblCollect_Master.ID, tblDesignMat.*, tblUnit.* FROM tblCollect_Master INNER JOIN tblDesignMat ON tblCollect_Master.DesignMat2 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE ID = $CollectID");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
        			<td class="InLineDataTD" width="13%"><?php echo $alldata['DesignMatQty2']?></td>
        			<td align="center" class="InLineDataTD"><?php echo $DesignMatData['UnitValue']?>&nbsp;</td>
        			<td align="right" class="InLineDataTD"><?php echo money_form($DesignMatData['DesignMatUnitPrice'])?></td>	
					<?php $DesignMatCost2 = ($alldata['DesignMatQty2'] * $DesignMatData['DesignMatUnitPrice']); ?>
        			<td colspan="2" align="right" class="InLineDataTD"><?php echo money_form($DesignMatCost2)?> </td>
				</tr>
				<tr>
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT tblCollect_Master.ID, tblDesignMat.*, tblUnit.* FROM tblCollect_Master INNER JOIN tblDesignMat ON tblCollect_Master.DesignMat3 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE ID = $CollectID");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
        			<td class="InLineDataTD" width="13%"><?php echo $alldata['DesignMatQty3']?></td>
        			<td align="center" class="InLineDataTD"><?php echo $DesignMatData['UnitValue']?>&nbsp;</td>
        			<td align="right" class="InLineDataTD"><?php echo money_form($DesignMatData['DesignMatUnitPrice'])?></td>	
					<?php $DesignMatCost3 = ($alldata['DesignMatQty3'] * $DesignMatData['DesignMatUnitPrice']); ?>
        			<td colspan="2" align="right" class="InLineDataTD"><?php echo money_form($DesignMatCost3)?> </td>
				</tr>
				<tr>
				<?php
					//if (!$alldata['DesignMat1'] == null)
					//{
						$DesignMatQuery = mysql_query("SELECT tblCollect_Master.ID, tblDesignMat.*, tblUnit.* FROM tblCollect_Master INNER JOIN tblDesignMat ON tblCollect_Master.DesignMat4 = tblDesignMat.DesignMatID INNER JOIN tblUnit ON tblDesignMat.DesignMatUnit = tblUnit.UnitID WHERE ID = $CollectID");
						$DesignMatData = mysql_fetch_array($DesignMatQuery);
					//}
				?>
        			<td class="InLineDataTD" width="15%"><?php echo $DesignMatData['DesignMatDescription']?>&nbsp;</td>
        			<td class="InLineDataTD" width="13%"><?php echo $alldata['DesignMatQty4']?></td>
        			<td align="center" class="InLineDataTD"><?php echo $DesignMatData['UnitValue']?>&nbsp;</td>
        			<td align="right" class="InLineDataTD"><?php echo money_form($DesignMatData['DesignMatUnitPrice'])?></td>	
					<?php $DesignMatCost4 = ($alldata['DesignMatQty4'] * $DesignMatData['DesignMatUnitPrice']); ?>
        			<td colspan="2" align="right" class="InLineDataTD"><?php echo money_form($DesignMatCost4)?> </td>
				</tr>
				<tr>
