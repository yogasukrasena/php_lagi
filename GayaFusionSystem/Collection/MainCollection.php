		...
		<td>
			...
			<table width="100%" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				$SizeData = mysql_fetch_array($Size);
  				...
  				echo"<tr>
					<td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"View_AddCollect.php?id=$alldata[ID]&des=$DesignData[DesignCode]&name=$NameData[NameCode]&cat=$CategoryData[CategoryCode]&size=$SizeData[SizeCode]&text=$TextureData[TextureCode]&col=$ColorData[ColorCode]&mat=$MaterialData[MaterialCode]\">$alldata[CollectCode]</a></td>
