...
$query = "SELECT * FROM tblOtherMat";
$FieldBox = $_POST['OtherMat'];
...
$query = $query . " ORDER BY OtherMatCode ASC LIMIT $from, $maxresult";
...
function openDialog(url, width, height, returnFunc, args) {
	if (!dialogWin.win || (dialogWin.win && dialogWin.win.closed)) {
		...
		dialogWin.returnedValue_OtherMatCode = ""
		dialogWin.args = args
		dialogWin.url = url
...
function setPrefs_ColorCodi() {
	...
	document.c_codificationSearch.OtherMat.value = dialogWin.returnedValue_OtherMat
}
</script>
</head>
...
<table width="765" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td>
		    <font class="InLineFormHeaderFont">List of OtherMat </font><br>
		...
		<td>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
    				<td class=\"InLineDataTD\"><input type=\"hidden\" name=\"OtherMatCode\" value=\"$alldata[OtherMatCode]\" />
					<a href=\"#\" onClick=\"javascript:window.opener.document.SampCeramicForm.OtherMat.value=document.OtherMatPopup.OtherMatCode.value;window.close()\" class=\"InLineDataLink\" >$alldata[OtherMatCode]	</a></td>
    				<td class=\"InLineDataTD\" colspan=\"5\">$alldata[OtherMatDescription]</td> 
    				<td class=\"InLineDataTD\"><img class=\"InLineInput\" height=\"50\" src=\"../UploadImg/$alldata[OtherMatPhoto1]\" 		width=\"50\">&nbsp;</td>
  				</tr>";
				}
				echo "<tr>";
