...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <tr>
    <td width="80" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">CODE</a></td>
    <td width="200" align="center" nowrap class="InLineColumnTD" ><a class="InLineSorterLink" href="{Sort_URL}">COMPANY</a>&nbsp;</td>
    <td width="150" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">CONTACT<br>PERSON </a></td>
    <td width="100" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">ITEMS</a></td>
    <td width="99" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">HP</a></td>
    <td width="102" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">OFFICE</a></td>
    <td width="99" align="center" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="{Sort_URL}">NOTES</a></td>
  </tr>
  <!-- BEGIN Row -->
  <?php
//  $jmldata=0; 
