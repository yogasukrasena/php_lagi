...
<!-- BEGIN Record c_codification -->
  ...
  <table class="GraphiteFormTABLE" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap="nowrap"><?php echo $alldata['ToolsCode'] ?>&nbsp;</td> 
      <td class="GraphiteDataTD"><?php echo $alldata['ToolsDescription'] ?>&nbsp;</td> 
    </tr>
 	<tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="right">&nbsp;</td> 
    </tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2">
	  	<table border="1" cellpadding="3" cellspacing="0" width="100%">
			<tr>
				<td height="500" valign="top"><?php echo $alldata['ToolsNotes'] ?></td>
			</tr>
		</table>	
	  </td> 
    </tr>
	...
	<tr>
	  <td colspan="2">
	  	<table width="100%" cellpadding="3" cellspacing="0" border="0">
			<tr>
	  			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[ToolsPhoto1]\" >" ?> </td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[ToolsPhoto2]\" >" ?></td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[ToolsPhoto3]\" >" ?></td>
				<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[ToolsPhoto4]\" >" ?></td> 
			</tr>
		</table>
	  </td>
    <tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="center" valign="middle">
        <p><?php echo "<img class=\"GraphiteInput\" height=\"750\" width=\"600\" src=\"../UploadImg/$alldata[ToolsTechDraw]\" >" ?></p> </td> 
    </tr>
</table>
