...
//$field1=$_POST['field1'];
//$field2=$_POST['field2'];
$field1=StainOxidcode;
$field2=StainOxidDescription;
...
$query = $query . " ORDER BY StainOxidCode ASC LIMIT $from, $maxresult";
...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndStainOxid.php" name="SearchStainOxide">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Stain &amp; Oxide </font></td>
		  </tr>
          <tr>
	  ...
	  <br>
      <font class="InLineFormHeaderFont">List of Stain & Oxide </font><br>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditStainOxid.php?id=$alldata[ID]\">$alldata[StainOxidCode]</a></td>
    <td class=\"InLineDataTD\" colspan=\"5\">$alldata[StainOxidDescription]</td> 
    <td class=\"InLineDataTD\"><img class=\"InLineInput\" height=\"50\" src=\"../UploadImg/$alldata[StainOxidPhoto1]\" width=\"50\">&nbsp;</td>
    <td class=\"InLineDataTD\">
	<a class=\"InLineDataLink\" href=\"ShowStainOxid.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditStainOxid.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<form name="AddStain & Oxide" action="AddData.php" method="post" >
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD STAIN &amp; OXIDE </td> 
    <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblStainOxid">
	<input type="hidden" name="field1" value="StainOxidCode">
	<input type="hidden" name="field2" value="StainOxidDescription">
	<input type="hidden" name="pagename" value="view_rndStainOxid.php">
  </tr>
  <!-- END Error -->
  <tr>
