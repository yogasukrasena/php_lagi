...
//$sid=10;
//$query=;
$result = mysql_query("SELECT tblDesMaterial.*, tblSupplier.* FROM tblDesMaterial INNER JOIN tblSupplier ON tblDesMaterial.DmSupplier = tblSupplier.SupCode WHERE tblDesMaterial.DmID = $id");
...
<!-- BEGIN Record c_codification -->
  ...
  <table class="GraphiteFormTABLE" cellspacing="1" cellpadding="3">
	...
	<tr>
	  ...
	  <td class="GraphiteDataTD"><?php echo $alldata['DmSupplier'] ?>&nbsp;</td>
    </tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="GraphiteDataTD"><?php echo $alldata['DmUnit'] ?>&nbsp;</td>
    </tr>
	<tr>
