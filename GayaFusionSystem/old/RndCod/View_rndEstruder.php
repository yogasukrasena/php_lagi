...
$query = $query . " ORDER BY EstruderCode ASC LIMIT $from, $maxresult";
...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndEstruder.php" name="SearchEstruder">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Estruder </font></td>
		  </tr>
          <tr>
	  ...
	  <br>
      <font class="InLineFormHeaderFont">List of Estruder </font><br>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditEstruder.php?id=$alldata[ID]\">$alldata[EstruderCode]</a></td>
    <td class=\"InLineDataTD\" colspan=\"5\">$alldata[EstruderDescription]</td> 
    <td class=\"InLineDataTD\"><img class=\"InLineInput\" height=\"50\" src=\"../UploadImg/$alldata[EstruderPhoto1]\" width=\"50\">&nbsp;</td>
    <td class=\"InLineDataTD\">
	<a class=\"InLineDataLink\" href=\"ShowEstruder.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditEstruder.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<form name="AddEstruder" action="AddData.php" method="post" >
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD ESTRUDER </td> 
    <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblEstruder">
	<input type="hidden" name="field1" value="EstruderCode">
	<input type="hidden" name="field2" value="EstruderDescription">
	<input type="hidden" name="pagename" value="view_rndEstruder.php">
  </tr>
  <!-- END Error -->
  <tr>
