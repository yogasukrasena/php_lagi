		...
		while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  			echo"<tr>
    			...
    			<td class=\"InLineDataTD\">
					<a class=\"InLineDataLink\" href=\"ShowSampOther.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
					<a class=\"InLineDataLink\" href=\"view_editsampOther.php?id=$alldata[ID]\" >edit</a>
				</td>
