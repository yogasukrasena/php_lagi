...
function openDialog(url, width, height, returnFunc, args) {
	if (!dialogWin.win || (dialogWin.win && dialogWin.win.closed)) {
		...
		dialogWin.returnedValue_EngobeCode = ""
		dialogWin.args = args
		dialogWin.url = url
...
function setPrefs_ColorCodi() {
	...
	document.c_codificationSearch.Engobe.value = dialogWin.returnedValue_Engobe
}
</script>
</head>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
					...
					<a href=\"#\" onClick=\"javascript:window.opener.document.SampCeramicForm.Engobe.value=document.EngobePopup.EngobeCode.value;window.close()\" class=\"InLineDataLink\" >$alldata[EngobeCode]	</a></td>
