...
?>
<?php
$querycari="select * from tblFiringPlan order by FiringPlancode";
...
<form method="post" action="{Action}" name="{HTMLFormName}">
  <font class="InLineFormHeaderFont">Search Firing Plan </font> 
 ...
 <!-- END Error -->
    <tr>
      ...
      <td class="InLineDataTD"><input class="InLineInput" value="code" name="kode" maxlength="12" size="12"></td>
...
<!-- BEGIN Grid c_codification --><font class="InLineFormHeaderFont">List of Firing Plan
</font><br>
...
//  $jmldata=0;
  while ($alldata = mysql_fetch_array($cari)){
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"{c_new_code_Src}\">$alldata[FiringPlanCode]</a></td>
    <td class=\"InLineDataTD\" colspan=\"5\">$alldata[FiringPlanDescription]</td> 
    <td class=\"InLineDataTD\">$alldata[FiringPlanphoto1]&nbsp;</td>
...
<form action="AddData.php" name="add_Firing" method="post">
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
	...
	<input type="hidden" name="pagename" value="rndFiring.html">
  </tr>
  <!-- END Error -->
  <tr>
    <td class="InLineFieldCaptionTD">Code</td>
