...
<!-- BEGIN Record c_codification -->
  ...
  <table class="GraphiteFormTABLE" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap="nowrap"><?php echo $alldata['StainOxidCode'] ?>&nbsp;</td> 
      <td class="GraphiteDataTD"><?php echo $alldata['StainOxidDescription'] ?>&nbsp;</td> 
    </tr>
 	<tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="right">&nbsp;</td> 
    </tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2">
	  	<table border="1" cellpadding="3" cellspacing="0" width="100%">
			<tr>
				<td height="500" valign="top"><?php echo $alldata['StainOxidNotes'] ?></td>
			</tr>
		</table>	
	  </td> 
    </tr>
	...
	<tr>
	  <td colspan="2">
	  	<table width="100%" cellpadding="3" cellspacing="0" border="0">
			<tr>
	  			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[StainOxidPhoto1]\" >" ?> </td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[StainOxidPhoto2]\" >" ?></td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[StainOxidPhoto3]\" >" ?></td>
				<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[StainOxidPhoto4]\" >" ?></td> 
			</tr>
		</table>
	  </td>
    <tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="center" valign="middle">
        <p><?php echo "<img class=\"GraphiteInput\" height=\"750\" width=\"600\" src=\"../UploadImg/$alldata[StainOxidTechDraw]\" >" ?></p> </td> 
    </tr>
</table>
