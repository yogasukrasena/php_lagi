...
function openDialog(url, width, height, returnFunc, args) {
	if (!dialogWin.win || (dialogWin.win && dialogWin.win.closed)) {
		...
		dialogWin.returnedValue_CastingCode = ""
		dialogWin.args = args
		dialogWin.url = url
...
function setPrefs_ColorCodi() {
	...
	document.c_codificationSearch.Casting.value = dialogWin.returnedValue_Casting
}
</script>
</head>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
					...
					<a href=\"#\" onClick=\"javascript:window.opener.document.SampCeramicForm.Casting.value=document.CastingPopup.CastingCode.value;window.close()\" class=\"InLineDataLink\" >$alldata[CastingCode]	</a></td>
