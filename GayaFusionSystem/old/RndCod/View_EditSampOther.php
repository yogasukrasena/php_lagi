...
function openDialog(url, width, height, returnFunc, args) {
  ...
  <table width="765" border="0" cellpadding="3" cellspacing="0">
	...
	<tr>
		...
		?>
		<FORM enctype="multipart/form-data" name="SampOtherForm" method="POST" action="EditSampOther.php" >
			<table class="InLineFormTABLE" width="850" border="0" cellspacing="0" cellpadding="3">
  				...
  				<tr>
    				...
    				<td class="InLineDataTD" colspan="5"><input type="text" name="DateField" value="<?php echo $alldata['SampleDate']; ?>" size="10" />&nbsp;<A HREF="javascript:void(0)" onClick="showCalendar(SampOtherForm.DateField,'yyyy-mm-dd','Choose date')"><img src="../images/DatePicker1.gif" width="17" height="15" border="0"/></A> </td>
  				</tr>
  				<tr>
  				...
  				<tr>
    				...
    				<td width="175" class="InLineDataTD">
						Ø=<input type="text" name="Diameter" value="<?php echo $alldata['Diameter']; ?>" size="15" />
					</td>
