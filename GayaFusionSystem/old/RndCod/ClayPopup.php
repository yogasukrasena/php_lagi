...
function openDialog(url, width, height, returnFunc, args) {
	if (!dialogWin.win || (dialogWin.win && dialogWin.win.closed)) {
		...
		dialogWin.returnedValue_ClayCode = ""
		dialogWin.args = args
		dialogWin.url = url
...
function setPrefs_ColorCodi() {
	...
	document.c_codificationSearch.Clay.value = dialogWin.returnedValue_Clay
}
</script>
</head>
		...
		<td>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
    				<td class=\"InLineDataTD\"><input type=\"hidden\" name=\"ClayCode\" value=\"$alldata[ClayCode]\" />
					<a href=\"#\" onClick=\"javascript:window.opener.document.SampCeramicForm.Clay.value=document.ClayPopup.ClayCode.value;window.close()\" class=\"InLineDataLink\" >$alldata[ClayCode]	</a></td>
