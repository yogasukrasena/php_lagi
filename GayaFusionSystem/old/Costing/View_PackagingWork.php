...
<?php
$query= "SELECT * FROM tblCosting_PackagingWork";
...
If (!empty($add)){
	If ((!empty($CostPerMinute)) || (!empty($PiecesPerHour))){
		$dataedit = "UPDATE tblCosting_PackagingWork SET 
			tblCosting_PackagingWork.CostPerMinute = '$CostPerMinute',
			tblCosting_PackagingWork.PiecesPerHour = '$PiecesPerHour';";
		$edit = mysql_query($dataedit);	
	}
}
else{
	$AddData = "INSERT INTO tblCosting_PackagingWork (CostPerMinute, PiecesPerHour) VALUE ('$CostPerMinute', '$PiecesPerHour')";
...
<table width="300" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td height="39" width="74%" class="TopContentTitle">PACKAGING WORK</td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2">
		<form name="ClayPreparationForm" method="post" action="View_PackagingWork.php">
