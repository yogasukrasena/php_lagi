...
If (!empty($add)){
	If ((!empty($CostPerMinute)) || (!empty($PiecesPerHour))){
		$dataedit = "UPDATE tblCosting_Casting SET 
			...
			tblCosting_Casting.PiecesPerHour = '$PiecesPerHour';";
		$edit = mysql_query($dataedit);	
	}
}
else{
	$AddData = "INSERT INTO tblCosting_Casting (CostPerMinute, PiecesPerHour) VALUE ('$CostPerMinute', '$PiecesPerHour')";
...
<table width="300" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2">
		<form name="ClayPreparationForm" method="post" action="View_Casting.php">
