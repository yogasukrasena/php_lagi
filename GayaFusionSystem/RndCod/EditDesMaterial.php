...
<HTML>
<head>
<META HTTP-EQUIV="refresh" content="1;URL=view_rndDesMaterial.php">
</head>
<BODY>
<?PHP
//$tabel = $_POST['tabel'];
...
$_rs ="UPDATE tblDesMaterial 
	...
	if ($query)
	{
		echo "<p>Record Successfuly Updated click </p> <a href=\"view_rndDesMaterial.php\"> here </a> to continue";
	}
	else
	{
		$sala=mysql_error();
