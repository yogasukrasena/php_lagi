...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndEngobe.php" name="SearchEngobe">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
		  <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Engobe </font></td>
		  </tr>
          <tr>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditEngobe.php?id=$alldata[ID]\">$alldata[EngobeCode]</a></td>
	...
	<a class=\"InLineDataLink\" href=\"ShowEngobe.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditEngobe.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<form name="AddEngobe" action="AddData.php" method="post" >
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD ENGOBE </td> 
    <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblEngobe">
	<input type="hidden" name="field1" value="EngobeCode">
	<input type="hidden" name="field2" value="EngobeDescription">
	<input type="hidden" name="pagename" value="view_rndEngobe.php">
  </tr>
  <!-- END Error -->
  <tr>
