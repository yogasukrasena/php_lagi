...
<!-- BEGIN Record c_codification -->
  ...
  <table class="GraphiteFormTABLE" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td class="GraphiteColumnTD" colspan="2" align="center">
	  	<table width="100%" border="0" cellspacing="0" cellpadding="3">
        	<tr>
       		  <td height="50" align="center" valign="middle"><h2>ESTRUDER</h2></td>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap="nowrap"><?php echo $alldata['EstruderCode'] ?>&nbsp;</td> 
      <td class="GraphiteDataTD"><?php echo $alldata['EstruderDescription'] ?>&nbsp;</td> 
    </tr>
 	<tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="right">&nbsp;</td> 
    </tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2">
	  	<table border="1" cellpadding="3" cellspacing="0" width="100%">
			<tr>
				<td height="500" valign="top"><?php echo $alldata['EstruderNotes'] ?></td>
			</tr>
		</table>	
	  </td> 
    </tr>
	...
	<tr>
	  <td colspan="2">
	  	<table width="100%" cellpadding="3" cellspacing="0" border="0">
			<tr>
	  			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[EstruderPhoto1]\" >" ?> </td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[EstruderPhoto2]\" >" ?></td> 
      			<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[EstruderPhoto3]\" >" ?></td>
				<td class="GraphiteDataTD" align="center"><?php echo "<img class=\"GraphiteInput\" width=\"150\" src=\"../UploadImg/$alldata[EstruderPhoto4]\" >" ?></td> 
			</tr>
		</table>
	  </td>
    <tr>
    ...
    <tr>
      <td class="GraphiteDataTD" nowrap colspan="2" align="center" valign="middle">
        <p><?php echo "<img class=\"GraphiteInput\" height=\"750\" width=\"600\" src=\"../UploadImg/$alldata[EstruderTechDraw]\" >" ?></p> </td> 
    </tr>
</table>
