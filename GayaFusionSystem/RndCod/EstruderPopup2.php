...
<title>R&amp;D - ESTRUDER</title>
<link rel="stylesheet" type="text/css" href="../includes/Style.css">
<SCRIPT LANGUAGE="JavaScript">
<!--
function pick(symbol) {
  if (window.opener && !window.opener.closed)
    window.opener.document.SampCeramicForm.Estruder2.value = symbol;
  window.close();
}
// -->
</SCRIPT></head>
			...
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				...
				<!-- BEGIN Row -->
  				...
  				echo"<tr>
					...
					<a href=\"#\" onClick=\"javascript:pick('$alldata[EstruderCode]')\" class=\"InLineDataLink\" >$alldata[EstruderCode]	</a></td>
