...
<table class="InLineFormTABLE" width="850" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    <td class="InlineDataTD" ><input type="text" name="Code" value="<?php echo $alldata['GlazeCode'] ?>" /></td>
  </tr>
  <tr>
    <td class="InlineDataTD">Description</td>
    <td class="InlineDataTD"><input type="text" name="Description" value="<?php echo $alldata['GlazeDescription'] ?>" /></td>
  </tr>
  <tr>
