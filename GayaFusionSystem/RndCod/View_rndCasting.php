...
<table width="765" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td colspan="2"><form method="post" action="view_rndCasting.php" name="SearchCasting">
        <table width="792" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
          <tr>
			<td colspan="8"><font class="InLineFormHeaderFont">Search Casting </font></td>
		  </tr>
          <tr>
...
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  ...
  while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  	echo"<tr>
    <td class=\"InLineDataTD\"><a class=\"InLineDataLink\" href=\"view_EditCasting.php?id=$alldata[ID]\">$alldata[CastingCode]</a></td>
	...
	<a class=\"InLineDataLink\" href=\"ShowCasting.php?id=$alldata[ID]\" target=\"_blank\">show</a>\t
    <a class=\"InLineDataLink\" href=\"view_EditCasting.php?id=$alldata[ID]\" >edit</a></td> 
  </tr>";
	}
echo "<tr>";
...
<form name="AddCasting" action="AddData.php" method="post" >
<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  <!-- BEGIN Error -->
  <tr>
    <td colspan="8" class="InLineColumnTD">ADD CASTING</td> <!-- disini pesan eror kalo code suda ada -->
	<input type="hidden" name="tablename" value="tblCasting">
	<input type="hidden" name="field1" value="CastingCode">
	<input type="hidden" name="field2" value="CastingDescription">
	<input type="hidden" name="pagename" value="view_rndCasting.php">
  </tr>
  <!-- END Error -->
  <tr>
