...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("tbluser");
}
...
class tDAL
{
	var $tblgayafusionall_at_localhost__tblcollect_category;
	var $tblgayafusionall_at_localhost__tblcollect_color;
	var $tblgayafusionall_at_localhost__tblcollect_design;
	var $tblgayafusionall_at_localhost__tblcollect_master;
	var $tblgayafusionall_at_localhost__tblcollect_name;
	var $tblgayafusionall_at_localhost__tbluser;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "tblcollect_category", "varname" => "gayafusionall_at_localhost__tblcollect_category", "altvarname" => "tblcollect_category", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		$this->lstTables[] = array("name" => "tblcollect_color", "varname" => "gayafusionall_at_localhost__tblcollect_color", "altvarname" => "tblcollect_color", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		$this->lstTables[] = array("name" => "tblcollect_design", "varname" => "gayafusionall_at_localhost__tblcollect_design", "altvarname" => "tblcollect_design", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		$this->lstTables[] = array("name" => "tblcollect_master", "varname" => "gayafusionall_at_localhost__tblcollect_master", "altvarname" => "tblcollect_master", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		$this->lstTables[] = array("name" => "tblcollect_name", "varname" => "gayafusionall_at_localhost__tblcollect_name", "altvarname" => "tblcollect_name", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		$this->lstTables[] = array("name" => "tbluser", "varname" => "gayafusionall_at_localhost__tbluser", "altvarname" => "tbluser", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
	}
