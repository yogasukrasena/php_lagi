...
require_once("include/tblcollect_category_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tblcollect_category" );
