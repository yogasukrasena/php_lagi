...
class ConnectionManager
{
	...
	{
		return $this->byId( "gayafusionall_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "gayafusionall_at_localhost";
		$data["connName"] = "gayafusionall";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;192.168.0.110;root;root;3306;gayafusionall;http://192.168.0.110/phprunner.php;1"; //currently unused

		$this->_connectionsIdByName["gayafusionall"] = "gayafusionall_at_localhost";
...
;
		...
		$connectionsData["gayafusionall_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["tblcollect_master"] = "gayafusionall_at_localhost";
		$connectionsIds["tblcollect_design"] = "gayafusionall_at_localhost";
		$connectionsIds["tblcollect_name"] = "gayafusionall_at_localhost";
		$connectionsIds["tblcollect_category"] = "gayafusionall_at_localhost";
		$connectionsIds["tblcollect_color"] = "gayafusionall_at_localhost";
		$connectionsIds["tbluser"] = "gayafusionall_at_localhost";
