...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tblcollect_master" ] = array( "url" => "tblcollect_master", "type" => 0 );
	$projectEntitiesReverse[ "tblcollect_master" ] = "tblcollect_master";
	$projectEntities[ "tblcollect_design" ] = array( "url" => "tblcollect_design", "type" => 0 );
	$projectEntitiesReverse[ "tblcollect_design" ] = "tblcollect_design";
	$projectEntities[ "tblcollect_name" ] = array( "url" => "tblcollect_name", "type" => 0 );
	$projectEntitiesReverse[ "tblcollect_name" ] = "tblcollect_name";
	$projectEntities[ "tblcollect_category" ] = array( "url" => "tblcollect_category", "type" => 0 );
	$projectEntitiesReverse[ "tblcollect_category" ] = "tblcollect_category";
	$projectEntities[ "tblcollect_color" ] = array( "url" => "tblcollect_color", "type" => 0 );
	$projectEntitiesReverse[ "tblcollect_color" ] = "tblcollect_color";
	$projectEntities[ "tbluser" ] = array( "url" => "tbluser", "type" => 0 );
	$projectEntitiesReverse[ "tbluser" ] = "tbluser";
}
