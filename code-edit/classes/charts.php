...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("tblcollect_master" == $this->chrt_array['tables'][0])
			return true;
		if("tblcollect_design" == $this->chrt_array['tables'][0])
			return true;
		if("tblcollect_name" == $this->chrt_array['tables'][0])
			return true;
		if("tblcollect_category" == $this->chrt_array['tables'][0])
			return true;
		if("tblcollect_color" == $this->chrt_array['tables'][0])
			return true;
		if("tbluser" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
