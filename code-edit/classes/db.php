...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "gayafusionall_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "tblcollect_category", "varname" => "gayafusionall_at_localhost__tblcollect_category", "altvarname" => "tblcollect_category", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
			$dalTables[$conn->connId][] = array("name" => "tblcollect_color", "varname" => "gayafusionall_at_localhost__tblcollect_color", "altvarname" => "tblcollect_color", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
			$dalTables[$conn->connId][] = array("name" => "tblcollect_design", "varname" => "gayafusionall_at_localhost__tblcollect_design", "altvarname" => "tblcollect_design", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
			$dalTables[$conn->connId][] = array("name" => "tblcollect_master", "varname" => "gayafusionall_at_localhost__tblcollect_master", "altvarname" => "tblcollect_master", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
			$dalTables[$conn->connId][] = array("name" => "tblcollect_name", "varname" => "gayafusionall_at_localhost__tblcollect_name", "altvarname" => "tblcollect_name", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
			$dalTables[$conn->connId][] = array("name" => "tbluser", "varname" => "gayafusionall_at_localhost__tbluser", "altvarname" => "tbluser", "connId" => "gayafusionall_at_localhost", "schema" => "", "connName" => "gayafusionall");
		}
	}
