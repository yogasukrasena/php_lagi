<?php
//BindEvents Method @1-B7FAA041
function BindEvents()
{
    global $tblcollect_texture;
    global $Panel1;
    global $CCSEvents;
    $tblcollect_texture->tblcollect_texture_TotalRecords->CCSEvents["BeforeShow"] = "tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow";
...
//tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow @8-8F938233
function tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow(& $sender)
{
    $tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $tblcollect_texture; //Compatibility
//End tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow

//Retrieve number of records @9-ABE656B4
    $Component->SetValue($Container->DataSource->RecordsCount);
//End Retrieve number of records

//Close tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow @8-7F367530
    return $tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow;
}
//End Close tblcollect_texture_tblcollect_texture_TotalRecords_BeforeShow
