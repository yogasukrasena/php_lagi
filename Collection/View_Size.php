...
?>
<?php
$field_value=$_POST['SizeSearch'];

If ($field_value == ''){
		$query="select * from tblCollect_Size";
	}
	elseif ($field_value !== ''){
		$query="select * from tblCollect_Size where SizeName LIKE '%$field_value%'";
	}
...
$query = $query . " ORDER BY SizeID ASC LIMIT $from, $maxresult";
...
function pick(id,code,name) {
  ...
  document.AddSize.CodeHid.value = id;
  document.AddSize.codenew.value = code;
  document.AddSize.descnew.value = name;  
}
...
<table width="450" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td height="38" width="74%" class="TopContentTitle">COLLECTION - SIZE</td>
	</tr>
	<tr>
    	<td colspan="2">&nbsp;</td>
  	</tr>
  	<tr>
    	<td colspan="2"><form method="post" action="View_Size.php" name="SearchSize">
        	<table width="450" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				<tr>
				<td colspan="3"><font class="InLineFormHeaderFont">Search Size </font></td>
				</tr>
          		<tr>
            		<td width="91" class="InLineFieldCaptionTD">Name</td>
            		<td class="InLineDataTD" ><input class="InLineInput" name="SizeSearch" maxlength="50" size="50"></td>
            		<td width="106" align="center" class="InLineDataTD"><input name="Search" type="submit" value="Search" class="InLineButton"></td>
          		</tr>
        	</table></form>
	  		<br>
      		<font class="InLineFormHeaderFont">List of Size </font><br>
			Total Records : <?php echo"<strong>$jumlah</strong>";?> &nbsp;<br>
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  				<tr>
    				<td width="159" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="#">SIZE ID</a></td>
    				<td width="282" nowrap class="InLineColumnTD" ><a class="InLineSorterLink" href="#">SIZE NAME </a>&nbsp;</td>
  				</tr>
  			<!-- BEGIN Row -->
  				<?php
  					while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  						echo"<tr>
    					<td class=\"InLineDataTD\"><a onClick=\"javascript:pick('$alldata[SizeID]','$alldata[SizeCode]','$alldata[SizeName]')\" class=\"InLineDataLink\" href=\"#\">$alldata[SizeCode]</a></td>
    					<td class=\"InLineDataTD\" colspan=\"5\">$alldata[SizeName]</td>
  						</tr>";
					}
					echo "<tr>";
			...
			<p></p>
			<form name="AddSize" action="AddData.php" method="post" >
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  				<tr>
    				<td colspan="8" class="InLineColumnTD">ADD SIZE</td> <!-- disini pesan eror kalo code suda ada -->
					<input type="hidden" name="tablename" value="tblCollect_Size">
					<input type="hidden" name="CodeHid" value="" />
					<input type="hidden" name="field0" value="SizeID">					
					<input type="hidden" name="field1" value="SizeCode">
					<input type="hidden" name="field2" value="SizeName">
					<input type="hidden" name="pagename" value="view_Size.php">
  				</tr>
  				<tr>
    				<td class="InLineFieldCaptionTD">Size ID</td>
    				<td class="InLineDataTD" colspan="5"><input class="InLineInput" name="codenew" value="" maxlength="12" size="12"></td>
				</tr>
				<tr>
    				<td class="InLineFieldCaptionTD">Size Name</td>
