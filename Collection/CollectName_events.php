...
//Page_BeforeInitialize @1-95B64B05
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $CollectName; //Compatibility
...
//Page_AfterInitialize @1-30339A44
