<?php
//BindEvents Method @1-5C6A5532
function BindEvents()
{
    global $GridDesign;
    global $Panel1;
    global $CCSEvents;
    $GridDesign->tblcollect_design_TotalRecords->CCSEvents["BeforeShow"] = "GridDesign_tblcollect_design_TotalRecords_BeforeShow";
...
//GridDesign_tblcollect_design_TotalRecords_BeforeShow @8-CC865C05
function GridDesign_tblcollect_design_TotalRecords_BeforeShow(& $sender)
{
    $GridDesign_tblcollect_design_TotalRecords_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $GridDesign; //Compatibility
//End GridDesign_tblcollect_design_TotalRecords_BeforeShow

//Retrieve number of records @9-ABE656B4
    $Component->SetValue($Container->DataSource->RecordsCount);
//End Retrieve number of records

//Close GridDesign_tblcollect_design_TotalRecords_BeforeShow @8-64BDFE5B
    return $GridDesign_tblcollect_design_TotalRecords_BeforeShow;
}
//End Close GridDesign_tblcollect_design_TotalRecords_BeforeShow
...
//Page_BeforeInitialize @1-9DFA8AF5
...
//Page_AfterInitialize @1-5C6C2D63
