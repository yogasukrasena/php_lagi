...
?>
<?php
$field_value=$_POST['MaterialSearch'];

If ($field_value == ''){
		$query="select * from tblCollect_Material";
	}
	elseif ($field_value !== ''){
		$query="select * from tblCollect_Material where MaterialName LIKE '%$field_value%'";
	}
...
$query = $query . " ORDER BY MaterialID ASC LIMIT $from, $maxresult";
$sqlcari= mysql_query($query);

?>
<html>
<head>
<title>COLLECTION - MATERIAL</title>
<link rel="stylesheet" type="text/css" href="../includes/Style-Collect.css">
<SCRIPT LANGUAGE="JavaScript">
<!--
function pick(id,code,name) {

  document.AddMaterial.CodeHid.value = id;
  document.AddMaterial.codenew.value = code;
  document.AddMaterial.descnew.value = name;  
}
...
<table width="450" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td height="38" width="74%" class="TopContentTitle">COLLECTION - MATERIAL</td>
	</tr>
	<tr>
    	<td colspan="2">&nbsp;</td>
  	</tr>
  	<tr>
    	<td colspan="2"><form method="post" action="View_Material.php" name="SearchMaterial">
        	<table width="450" cellpadding="3" cellspacing="0" class="InLineFormTABLE">
				<tr>
				<td colspan="3"><font class="InLineFormHeaderFont">Search Material </font></td>
				</tr>
          		<tr>
            		<td width="91" class="InLineFieldCaptionTD">Name</td>
            		<td class="InLineDataTD" ><input class="InLineInput" name="MaterialSearch" maxlength="50" size="50"></td>
            		<td width="106" align="center" class="InLineDataTD"><input name="Search" type="submit" value="Search" class="InLineButton"></td>
          		</tr>
        	</table></form>
	  		<br>
      		<font class="InLineFormHeaderFont">List of Material </font><br>
			Total Records : <?php echo"<strong>$jumlah</strong>";?> &nbsp;<br>
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  				<tr>
    				<td width="159" nowrap class="InLineColumnTD"><a class="InLineSorterLink" href="#">MATERIAL ID</a></td>
    				<td width="282" nowrap class="InLineColumnTD" ><a class="InLineSorterLink" href="#">MATERIAL NAME </a>&nbsp;</td>
  				</tr>
  			<!-- BEGIN Row -->
  				<?php
  					while ($alldata = mysql_fetch_array($sqlcari)){ //ini nampilin data
  						echo"<tr>
    					<td class=\"InLineDataTD\"><a onClick=\"javascript:pick('$alldata[MaterialID]','$alldata[MaterialCode]','$alldata[MaterialName]')\" class=\"InLineDataLink\" href=\"#\">$alldata[MaterialCode]</a></td>
    					<td class=\"InLineDataTD\" colspan=\"5\">$alldata[MaterialName]</td>
  						</tr>";
					}
					echo "<tr>";
			...
			<p></p>
			<form name="AddMaterial" action="AddData.php" method="post" >
			<table cellpadding="3" cellspacing="0" class="InLineFormTABLE">
  				<tr>
    				<td colspan="8" class="InLineColumnTD">ADD MATERIAL</td> <!-- disini pesan eror kalo code suda ada -->
					<input type="hidden" name="tablename" value="tblCollect_Material">
					<input type="hidden" name="CodeHid" value="" />
					<input type="hidden" name="field0" value="MaterialID">					
					<input type="hidden" name="field1" value="MaterialCode">
					<input type="hidden" name="field2" value="MaterialName">
					<input type="hidden" name="pagename" value="view_Material.php">
  				</tr>
  				<tr>
    				<td class="InLineFieldCaptionTD">Material ID</td>
    				<td class="InLineDataTD" colspan="5"><input class="InLineInput" name="codenew" value="" maxlength="12" size="12"></td>
				</tr>
				<tr>
    				<td class="InLineFieldCaptionTD">Material Name</td>
